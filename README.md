# LL Match Logger — Windows Desktop App v1.2.0

This is **v1.2.0** of LL Match Logger, the standalone Windows desktop build for football live logging.
...
`LL-Match-Logger-1.2.0-portable.exe`

The app itself also displays **v1.2.0** in the interface so the version being tested is unambiguous.
